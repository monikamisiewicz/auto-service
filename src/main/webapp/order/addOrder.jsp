...
<form action="/addOrder" method="post">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" name="repairAcceptanceDate" required placeholder="yyyy-mm-dd" id="repairAcceptance"/>
    </div>

    <div class="form-group">
        <label for="plannedStart">Planned repair start</label>
        <input type="date" class="form-control" name="plannedRepairStart" required placeholder="yyyy-mm-dd" id="plannedStart"/>
    </div>

    <div class="form-group">
        <label for="repairStart">Repair start</label>
        <input type="date" class="form-control" name="repairStart" placeholder="yyyy-mm-dd" id="repairStart">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" min="0.00" step="0.01" name="manHourCost" placeholder="Man hour cost" id="manHourCost">
    </div>
    <div class="form-group">
        <label for="manHours">Man hour amount</label>
        <input type="number" class="form-control" min="0" step="1" name="manHourAmount" placeholder="Man hour amount" id="manHours">
    </div>
