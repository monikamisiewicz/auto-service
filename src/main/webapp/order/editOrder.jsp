...
<%--                    <c:if test="${order.employeeId == employee.id}">--%>
<%--                        <div>--%>
<%--                            <option selected value="${employee.id}">${employee.firstName} ${employee.lastName}</option>--%>
<%--                        </div>--%>
...
<%--        <div><input type="number" min="0.00" step="0.01" name="manHourCost" selected value="${order.manHourCost}"></div>--%>
<%--    </div>--%>

<%--    &lt;%&ndash;    <div>&ndash;%&gt;--%>
<%--    &lt;%&ndash;        <label>Customer cost</label>&ndash;%&gt;--%>
<%--    &lt;%&ndash;        <div><input type="number" min="0.00" step="0.01" name="customerCost" value="${order.customerCost}"></div>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    </div>&ndash;%&gt;--%>
<%--    <div>--%>
<%--        <label>Spareparts cost</label>--%>
<%--        <div><input type="number" min="0.00" step="0.01" name="sparepartsCost" value="${order.sparepartsCost}"></div>--%>
<%--    </div>--%>

<%--    <div>--%>
<%--        <label>Man hour amount</label>--%>
<%--        <div><input type="number" min="0" step="1" name="manHourAmount" value="${order.manHourAmount}"></div>--%>
<%--    </div>--%>
...
<%--                    <c:if test="${order.vehicleId == vehicle.id}">--%>
<%--                        <option selected--%>
<%--                                value="${vehicle.id}">${vehicle.model} ${vehicle.brand} ${vehicle.registrationNumber}</option>--%>
<%--                    </c:if>--%>
<%--                    <c:if test="${order.vehicleId != vehicle.id}">--%>
...
<%--                    <c:if test="${order.statusId == status.id}">--%>
<%--                        <option selected value="${status.id}">${status.name}</option>--%>
<%--                    </c:if>--%>
<%--                    <c:if test="${order.statusId != status.id}">--%>
